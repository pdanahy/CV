...
parser.add_argument('--r', help='Min value for Color Clamping', default=256)
parser.add_argument('--g', help='Max value for Color Clamping', default=256)
parser.add_argument('--b', help='Max value for Color Clamping', default=256)
...
def segmentation_call(filepath, count):
  ...
  for contour in contours:
      colors.append((rng.randint(0,int(args.r)), rng.randint(0,int(args.g)), rng.randint(0,int(args.b))))
  ...
  cv.imwrite(os.path.join('./segmented/', outpath), dst)
  print("done")
